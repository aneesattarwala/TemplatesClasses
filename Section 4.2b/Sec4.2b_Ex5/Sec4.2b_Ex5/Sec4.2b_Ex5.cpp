...
//  Implementation of Exception class to throw stack exception objects. Stack full and stack empty exception classes are inherited from abstract base class. Main catches stack exception thrown by StackException.
